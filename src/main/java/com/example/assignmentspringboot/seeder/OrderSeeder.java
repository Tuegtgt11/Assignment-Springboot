...
import com.example.assignmentspringboot.util.DateTimeHelper;
    ...
    public void generate() {
        ...
        for (OrderSeedByTime orderSeedByTime :
            ...
            for (int i = 0; i < NUMBER_OF_ORDER; i++) {
                ...
                order.setUserId(UUID.randomUUID().hashCode());
